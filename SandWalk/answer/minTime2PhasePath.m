function output = minTime2PhasePath(u1,u2,W,H,h)
...
bounds.phase(i).control.upper = [u1,u1];                % row vector, length = numstates
...
bounds.phase(i).control.lower = [0,0];                % row vector, length = numstates
bounds.phase(i).control.upper = [u2,u2];                % row vector, length = numstates
...
guess.phase(i).control = u2*rand(2,2);                % array, min numrows = 2, numcols = numcontrols
